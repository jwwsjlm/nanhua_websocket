...
function jiami(msgid,seq) {
    ...
    var h = window.guan_.create(s);
    var l = window.guan_.encode(h).finish();
...
function decode(tt){
	...
	let e = t=>window.guan_.toObject(window.guan_.decode(new Uint8Array(tt)), {longs: Number});
...
/*
{
		...
		*/
    var {QuoteMsgID: Y, QuotationFreq: X, QuotationMsg: guan_} = O.jadegold.msg.quotation.pbv2;
    window.guan_ = guan_;
})()